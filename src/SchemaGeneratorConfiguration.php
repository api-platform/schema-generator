    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $treeBuilder
            ...
            ->children()
                ...
                ->arrayNode('vocabularies')
                    ...
                    ->arrayPrototype()
                        ->children()
                            ...
                            ->booleanNode('nameAllFromLabels')->defaultFalse()->info('Make use of the label information when possible to define all entities names in this vocabulary?')->end()
                            ->scalarNode('language')->defaultNull()->info('The language to use, with this vocabulary, among the labels when used as entities names, e.g., en')->end()
                            ->scalarNode('namingConvention')->defaultNull()->info('The naming convention to use, with this vocabulary, when naming entities from their labels; the default value is camel case (possible values are "snake case" or "camel case"), classes have first charater in uppercase')->end()
                ...
                ->booleanNode('nameAllFromLabels')->defaultFalse()->info('Make use of the label information when possible to define all entities names?')->end()
                ->scalarNode('language')->defaultNull()->info('The language to use among the labels when used as entities names, e.g., en')->end()
                ->scalarNode('namingConvention')->defaultNull()->info('The naming convention to use when naming entities from their labels; the default value is camel case (possible values are "snake case" or "camel case"), classes have first charater in uppercase')->end()
                ...
                ->arrayNode('types')
                    ...
                    ->arrayPrototype()
                        ->children()
                            ...
                            ->booleanNode('nameFromLabel')->defaultFalse()->info('Make use of the label if possible to define this type entity name?')->end()
                            ->scalarNode('language')->defaultNull()->info('The language to use among the labels when used as entity name for the current type, e.g., en')->end()
                            ->scalarNode('namingConvention')->defaultNull()->info('The naming convention to use when naming entities from the labels related to the current type; the default value is camel case (possible values are "snake case" or "camel case"), classes have first charater in uppercase')->end()
                            ->arrayNode('namespaces')
                                ->addDefaultsIfNotSet()
